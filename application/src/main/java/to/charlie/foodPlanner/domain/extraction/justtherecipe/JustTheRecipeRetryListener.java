...
@Slf4j
@Component("justTheRecipeRetryListener")
public class JustTheRecipeRetryListener implements RetryListener {
  ...
  public <T, E extends Throwable> void onError(final RetryContext context,
    ...
    log.warn("JustTheRecipe API call failed. Retry attempt: {}. Error: {}",
